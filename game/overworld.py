...
class Node(pg.sprite.Sprite):
    ...
    def update(self):
        if self.status == "available":
            ...
            tinted_surface.fill("black", None, pg.BLEND_RGBA_MULT)
...
class Icon(pg.sprite.Sprite):
    def __init__(self, pos):
        super().__init__()
        self.pos = pos
        self.image = pg.image.load("../graphics/overworld/hat.png").convert_alpha()
        self.rect = self.image.get_rect(center=pos)
...
class Overworld:
    ...
    def draw_paths(self):
        if self.max_level > 0:
            ...
            pg.draw.lines(self.display_surface, "#a04f45", False, points, 6)
    ...
    def get_movement_data(self, target="next"):
